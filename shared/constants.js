...
export const SOLDIER_W = 44, SOLDIER_H = 84;
...
export function partOrigin(trimW, trimH, srcW, srcH, ax, ay, offX = 0, offY = 0) {
  const sw = srcW || trimW, sh = srcH || trimH, tw = trimW || 1, th = trimH || 1;
